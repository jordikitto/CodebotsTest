 ...
 */
package jordisapp.cucumber.suites;
...
@CucumberOptions(
		...
		glue = {
				...
				"jordisapp.cucumber.registry",
				"jordisapp.cucumber.hooks",
				"jordisapp.cucumber.stepdefs"
		},
		features = {
				// % protected region % [Add any additional features here] off begin
				// % protected region % [Add any additional features here] end
				"src/test/java/jordisapp/cucumber/features"
		},
		plugin = {
