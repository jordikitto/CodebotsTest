 ...
 */
package jordisapp.configs.security.services;

import jordisapp.configs.security.helpers.AnonymousHelper;
import jordisapp.configs.security.repositories.UserRepository;
import jordisapp.configs.security.exceptions.*;
import jordisapp.entities.*;
import jordisapp.lib.services.email.*;
 ...
 * to {@link jordisapp.services.UserService}. Whereas {@link jordisapp.services.UserService} is simply used as a base
