...
package jordisapp.configs.security.repositories;
 ...
 * {@link jordisapp.repositories.UserRepository} since we want to be able to query all user tables at once
 ...
 * against all user types at once, which is not possible for {@link jordisapp.repositories.UserRepository}.
 */
@Repository
public interface UserRepository extends jordisapp.repositories.UserRepository<UserEntity> {
